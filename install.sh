...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/wireguard"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="wireguard"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/wireguard"
APPDIR="$HOME/.local/share/srv/docker/wireguard"
DATADIR="$HOME/.local/share/srv/docker/wireguard/rootfs"
...
TZ=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default wireguard
CONTAINER_HOSTNAME=""
CONTAINER_DOMAINNAME=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# URL to container image [docker pull URL]
HUB_IMAGE_URL="weejewel/wg-easy"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
